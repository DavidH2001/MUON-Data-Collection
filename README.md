...
from a pairs of Muon detectors running in coincidence (master M and slave S) mode.   
...
Check that the information is correct e.g., *user_id*, *buff_size*, etc. Also ensure that your computer is connected
